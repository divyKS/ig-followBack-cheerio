...
const html = fs.readFileSync('followers.html', 'utf8');
...
$('a[role="link"] span[dir="auto"]').each((index, element) => {
    const id = $(element).text();
    userID.push(id);
});

$('span[dir="auto"]:not(a span[dir="auto"])').each((index, element)=>{
...
const fileName = 'followers_ID_Only.txt';
